      ...
      <div className="login-left">
        <div>
          ...
          <div className="brand-visual">
            <img src="https://images.unsplash.com/photo-1589136777351-fdc9c9cb1669?q=80&w=800&auto=format&fit=crop" alt="Kori Alp Illustration" className="brand-image" style={{ borderRadius: '12px' }} />
          </div>
